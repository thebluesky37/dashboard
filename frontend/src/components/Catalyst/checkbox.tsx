...
const base = [
  ...
  "group-data-[disabled]:border-gray-950/25 group-data-[disabled]:bg-gray-950/5 group-data-[disabled]:[--checkbox-check:theme(colors.zinc.950/50%)] group-data-[disabled]:before:bg-transparent",
