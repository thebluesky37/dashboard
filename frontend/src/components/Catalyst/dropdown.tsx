  ...
  return (
    <HeadlessMenuItem
      ...
      className={clsx(
        ...
        // Text styles
        "text-left text-base/6 text-gray-950 sm:text-sm/6 forced-colors:text-[CanvasText]",
        ...
        "[&>[data-slot=icon]]:text-gray-500 [&>[data-slot=icon]]:data-[focus]:text-white"
      )}
    />
  );
}
...
export function DropdownHeading({
  ...
  return (
    <HeadlessMenuHeading
      ...
      className={clsx(
        className,
        "col-span-full grid grid-cols-[1fr,auto] gap-x-12 px-3.5 pb-1 pt-2 text-sm/5 font-medium text-gray-500 sm:px-3 sm:text-xs/5"
      )}
    />
  );
}
...
export function DropdownSeparator({
  ...
  return (
    <HeadlessMenuSeparator
      ...
      className={clsx(
        className,
        "col-span-full mx-3.5 my-1 h-px border-0 bg-gray-950/5 sm:mx-3 forced-colors:bg-[CanvasText]"
      )}
    />
  );
}
