...
export function TableHead({
  ...
  return (
    <thead
      className={clsx(className, "text-gray-600")}
      {...props}
    />
  );
}
    ...
    >
      <tr
        ...
        className={clsx(
          ...
          striped && "even:bg-gray-100/70",
          href && striped && "hover:bg-gray-100",
          href &&
            !striped &&
            "hover:bg-gray-50"
        )}
...
export function TableHeader({
  ...
  return (
    <th
      ...
      className={clsx(
        className,
        "border-b border-b-gray-200 px-4 py-2 font-medium first:pl-[var(--gutter,theme(spacing.2))] last:pr-[var(--gutter,theme(spacing.2))]",
  ...
  return (
    <td
      ...
      className={clsx(
        ...
        !striped && "border-b border-gray-200",
        grid && "border-l border-l-gray-200 first:border-l-0",
        dense ? "py-2.5" : "py-4",
        !bleed && "sm:first:pl-2 sm:last:pr-2"
      )}
